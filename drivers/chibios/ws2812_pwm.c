...
#    elif defined(USE_GPIOV3)
#        define WS2812_OUTPUT_MODE PAL_MODE_ALTERNATE(WS2812_PWM_PAL_MODE) | PAL_STM32_OTYPE_PUSHPULL | PAL_STM32_OSPEED_HIGH | PAL_STM32_PUPDR_FLOATING
#    else
#       error "Unsupported GPIO version"
#    endif
#else
#    if defined(USE_GPIOV1)
