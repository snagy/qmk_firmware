...
// wiring
#define MATRIX_ROW_PINS { A15, F0, B1, B2, B10 }
#define MATRIX_COL_PINS { B15, B9, B7, B6, B5, B4, B3 }
#define UNUSED_PINS
#define MATRIX_ROW_PINS_RIGHT { A10, A8, B12, B5, B7 }
#define MATRIX_COL_PINS_RIGHT { B0, B1, B2, B13, B14, B15, B4 }
...
#define AUDIO_CLICKY_ON TRUE

#define AUDIO_NOTE_TIMER 1
